...
rjovelin
Richard Jovelin added a comment - 24/Aug/22 3:19 PM
Added a 3rd way to filter worklow output files using key "rename_files" in the json.

"extension", "files" and "rename_files" are mutually exclusive for a given workflow but can be mixed within the json (see example below).
...
{"workflow_id": "19168526", "workflow_version":"2.0.2", "name": "calls.copynumber", "rename_files": [{"file_path": "file1", "file_name": "myfile1",

{"file_path": "file2", "file_name": "this_is_a_file"}
] }
