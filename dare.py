...
def map_QC_metrics_to_fpr(FPR_info, bamqc_info, cfmedipqc_info):
    '''
    (dict, dict) -> None
...
def write_batch_report(args):
    ...
    map_QC_metrics_to_fpr(files, bamqc_info, cfmedipqc_info)    
    ...
    figure_files = {}
    metrics, Y_axis = {}, {}
    for library_source in ['CM', 'WG', 'TS', 'EX']:
        if library_source == 'CM':
